    ...
    <div class="row">
        <div class="col-md-6">
            <div class="main-card mb-3 card">
                    ...
                    <div>
                    <form action="{{url('/admin/resubcategory/update')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="position-relative form-group"><label for="exampleFile" class="">Unit Code</label>
                            <input type="text" class="form-control" name="unit_code"  placeholder="Enter Unit Code" value="{{ $edit->unit_code }}">
                            ...
                            <select class="form-control" name="category_id" id="category_id" onchange="getSubCategory(this)">
                                <option disabled selected>Select</option>
                                    @foreach ($allCategories as $cate)
                                        <option value="{{ $cate->id }}" {{ $edit->category_id == $cate->id ? 'selected' : '' }}>{{ $cate->category_name }}</option>
                                    @endforeach
                                </select>
                                @error('category_id')
                                    <small class="text-danger">{{ $message }}</small>
                        ...
                        <div class="position-relative form-group"><label for="exampleFile" class="">Sub Category</label>
                            @php
                                $allSubcategories=App\Models\SubCategory::where('is_deleted',0)->where('category_id',$edit->category_id)->get();
                            @endphp
                            <select class="form-control" name="subcategory_id" id="sub_category">
                                <option disabled selected>Select</option>
                                   @foreach ($allSubcategories as $subcate)
                                        <option value="{{ $subcate->id }}" {{ $edit->subcategory_id == $subcate->id ? 'selected' : '' }}>{{ $subcate->subcategory_name }}</option>
                                    @endforeach
                            </select>
                        ...
                        <br>
                            ...
                            <div class="position-relative form-group">
                                <div class="form-check">
                                    <input class="form-check-input" name="past_papers" type="checkbox" value="1" id="flexCheckDefault" @if($edit->past_papers==1) checked @endif>
                            ...
                            <div class="position-relative form-group">
                                <div class="form-check">
                                    <input class="form-check-input" name="revision_notes" type="checkbox" value="1" id="flexCheckDefault" @if($edit->revision_notes==1) checked @endif>
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Revision Notes
                                    </label>
                                </div>
                            ...
                            <div class="position-relative form-group">
                                <div class="form-check">
                                    <input class="form-check-input" name="exam_questions" type="checkbox" value="1" id="flexCheckDefault" @if($edit->exam_questions==1) checked @endif>
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Exam Questions
                                    </label>
                                </div>
                            ...
                            <div class="position-relative form-group">
                                <div class="form-check">
                                    <input class="form-check-input" name="flashcards" type="checkbox" value="1" id="flexCheckDefault" @if($edit->flashcards==1) checked @endif>
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Flash Cards
                                    </label>
                                </div>
