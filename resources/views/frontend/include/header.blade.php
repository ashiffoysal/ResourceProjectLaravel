                                ...
                                <ul class="rbt-information-list">
                                    <li>
                                        <a href="mailto:{{ $companyInformation->email }}">
                                            <i class="feather-email"></i>{{ $companyInformation->email }}
                                        </a>
                                    </li>
                            ...
                            <div class="header-info">
                                <ul class="rbt-dropdown-menu switcher-language">
                                    <li class="has-child-menu">
                                        <a href="#">
                                            <img class="left-image" src="{{ asset('frontend') }}/assets/images/icons/en-us.png"
                                                alt="Language Images">
                                        ...
                                        <ul class="sub-menu">
                                            <li>
                                                <a href="#">
                                                    <img class="left-image" src="{{ asset('frontend') }}/assets/images/icons/fr.png"
                                                        alt="Language Images">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="left-image" src="{{ asset('frontend') }}/assets/images/icons/de.png"
                                                        alt="Language Images">
                                    ...
                                    <div class="rbt-vertical-nav">
                                        <ul class="rbt-vertical-nav-list-wrapper vertical-nav-menu">
                                            ...
                                            <li class="vertical-nav-item">
                                                <a href="#tab{{ ++$key }}">{{ $category->category_name }}</a>
                                            </li>
                                            @endforeach
                                        </ul>
                                    </div>
                                    <div class="rbt-vertical-nav-content">
                                        @foreach ($allCategory as $catekey => $category)
                                        <div class="rbt-vertical-inner tab-content" id="tab{{ ++$catekey }}"
                                            style="display: block">
                                            <div class="rbt-vertical-single">
                                                <div class="row">
                                                    <div class="col-lg-12 col-sm-12 col-12">
                                                        <div class="vartical-nav-content-menu">
                                                            <h3 class="rbt-short-title">{{ $category->category_name }}</h3>
                                                            <ul class="rbt-vertical-nav-list-wrapper">
                                                                @php
                                                                    $allSubcategory=App\Models\SubCategory::where('category_id',$category->id)->where('is_deleted',0)->where('is_active',1)->select(['subcategory_name','id','slug'])->get();
                                                                @endphp
                                                                @foreach ($allSubcategory as $subcategory)
                                                                 <li><a href="{{ url('resources') }}/{{ $category->slug}}/{{ $subcategory->slug }}">{{ $subcategory->subcategory_name }}</a></li>
                                                                @endforeach
                                                            </ul>
                                                        </div>
                                                    </div>
                    ...
                    <nav class="mainmenu-nav">
                        <ul class="mainmenu">
                            ...
                            <li class="has-dropdown has-menu-child-item">
                                ...
                                <ul class="submenu">
                                    @foreach ($allCategory as $catekey => $category)
                                    <li class="has-dropdown"><a href="#">{{ $category->category_name }}</a>
                                        <ul class="submenu">
                                            @php
                                                $allSubcategory=App\Models\SubCategory::where('category_id',$category->id)->where('is_deleted',0)->where('is_active',1)->select(['subcategory_name','id','slug'])->get();
                                            @endphp
                            ...
                            <li class="has-dropdown has-menu-child-item">
                                ...
                                <ul class="submenu">
                                    <li class="has-dropdown"><a href="{{ url('/schools-pricing') }}">Schools</a>
                                     
                                    </li>
                                    <li class="has-dropdown"><a href="{{ url('/individuals-pricing') }}">Individuals</a>
                            ...
                            <li class="has-dropdown has-menu-child-item">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="has-dropdown"><a href="#">Exam Centre London</a>
                                        <ul class="submenu">
                                            <li><a target="__blank" href="https://www.examcentrelondon.co.uk/gcse-exams">GCSE</a></li>
                                            <li><a target="__blank" href="https://www.examcentrelondon.co.uk/igcse-exams">IGCSE</a></li>
                                            <li><a target="__blank" href="https://www.examcentrelondon.co.uk/a-level-exams">A Level</a></li>
                                            <li><a target="__blank" href="https://www.examcentrelondon.co.uk/exam-booking-aslevel">AS Level</a></li>
                                            <li><a target="__blank" href="https://www.examcentrelondon.co.uk/aat-exams">AAT</a></li>
                                            <li><a target="__blank" href="https://www.examcentrelondon.co.uk/acca-exams">ACCA</a></li>
                                            <li><a target="__blank" href="https://www.examcentrelondon.co.uk/functional-skills-exams">Functional Skills</a></li>
                                            <li><a target="__blank" href="https://www.examcentrelondon.co.uk/proctor-exam-details">Proctor Exam</a></li>
                                            <li><a target="__blank" href="https://www.examcentrelondon.co.uk/iseb-details">ISEB Exam</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                ...
                <div class="header-right">
                    ...
                    <ul class="quick-access">
                        ...
                        <li class="account-access rbt-user-wrapper d-none d-xl-block">
                            ...
                            <a href="{{ url('/dashboard') }}"><i class="feather-user"></i>Dashboard</a>
                            <div class="rbt-user-menu-list-wrapper">
                                <div class="inner">
                                    <div class="rbt-admin-profile">
                                        <div class="admin-thumbnail">
                                            <img src="{{ asset('frontend') }}/assets/images/team/avatar.jpg" alt="User Images">
                                        </div>
                                    ...
                                    <ul class="user-list-wrapper">
                                        ...
                                        <li>
                                            <a href="{{ url('/subcription-details') }}">
                            ...
                            <div class="row row--15 home-plesentation-wrapper single-dropdown-menu-presentation">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="01-main-demo.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h1.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="12-marketplace.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h12.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="04-kindergarten.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h4.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="13-university-classic.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h13.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="14-home-elegant.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h14.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="09-gym-coaching.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h9.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="03-online-school.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h3.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="06-university-status.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h6.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="15-home-technology.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h15.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="07-instructor-portfolio.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h7.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="08-language-academy.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h8.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="11-single-course.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h11.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="10-online-course.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h10.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="05-classic-lms.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h5.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="02-course-school.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h2.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="16-udemy-affiliate.html"><img
                                                        src="{{ asset('frontend') }}/assets/images/splash/demo/h16.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                ...
                                <div
                                    ...
                                    <div class="demo-single">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="#"><img src="{{ asset('frontend') }}/assets/images/splash/demo/coming-soon-1.png"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                ...
                                <div
                                    ...
                                    <div class="demo-single">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="#"><img src="{{ asset('frontend') }}/assets/images/splash/demo/coming-soon-2.png"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-12 col-xl-3 col-xxl-3 single-mega-item">
                                    <div class="mega-category-item">
                                        ...
                                        <div class="nav-category-item">
                                            <div class="thumbnail">
                                                <div class="image"><img src="{{ asset('frontend') }}/assets/images/course/category-2.png"
                                        ...
                                        <div class="nav-category-item">
                                            <div class="thumbnail">
                                                <div class="image"><img src="{{ asset('frontend') }}/assets/images/course/category-1.png"
                                                        alt="Course images"></div>
                                                <a href="course-filter-one-toggle.html">
                                        ...
                                        <div class="nav-category-item">
                                            <div class="thumbnail">
                                                <div class="image"><img src="{{ asset('frontend') }}/assets/images/course/category-4.png"
                                                        alt="Course images"></div>
                                                <a href="course-filter-one-toggle.html">
                                        ...
                                        <div class="nav-category-item">
                                            <div class="thumbnail">
                                                <div class="image"><img src="{{ asset('frontend') }}/assets/images/course/category-9.png"
                                                        alt="Course images"></div>
                                                <a href="course-filter-one-toggle.html">
                                                    <span>Academy</span>
                                                    <i class="feather-chevron-right"></i>
                            ...
                            <div class="row row--15">
                                ...
                                <div class="col-lg-12 col-xl-4 col-xxl-4 single-mega-item">
                                    <div class="rbt-ads-wrapper">
                                        <a class="d-block" href="#"><img src="{{ asset('frontend') }}/assets/images/service/mobile-cat.jpg"
